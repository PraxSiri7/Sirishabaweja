...
backgroundGradient.addColorStop(0, "#020d17");
backgroundGradient.addColorStop(1, "#04131f");
...
function init() {
  ...
  for (let i = 0; i < 200; i++) {
    ...
    backgroundStars.push(new Star(x, y, radius, "#e7edbe"));
  }
}
...
function animate() {
  ...
  if (flag) creatMountainRange(1, canvas.height * 0.7, "#063d13");
  if (flag) creatMountainRange(2, canvas.height * 0.6, "#05210b");
  if (flag) creatMountainRange(3, canvas.height * 0.4, "#031206");
  c.fillStyle = "#572709";
  ...
  if (ticker % randomSpawnRate == 0) {
    ...
    stars.push(new Star(x, -100, 9, "#e7edbe"));
